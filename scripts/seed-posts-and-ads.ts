...
import { AdPosition, AdSize, PostStatus, PostType, PrismaClient, Role } from '@prisma/client';
...
const POSTS: PostSeed[] = [
  ...
  },
  {
    ...
    content:
      '<p>قیمت سکه طرح جدید در هفته‌ی گذشته با افزایش چشمگیری روبرو شد. مهم‌ترین دلایل این افزایش عبارتند از:</p><ul><li>افزایش قیمت اونس جهانی</li><li>کاهش ارزش دلار در بازار آزاد</li><li>تقاضای فصلی برای سکه</li><li>انتظارات تورمی</li></ul>',
    categories: ['طلا'],
    daysAgo: 1,
    viewCount: 8900,
    readingTime: 4,
  ...
  },
  {
    ...
    content:
      '<p>طلای آب شده به دلیل کارمزد پایین‌تر و قابلیت نقدشوندگی بالا، مورد توجه قرار گرفته است.</p>',
  ...
  },
  {
    ...
    content:
      '<p>قیمت اونس طلا در معاملات امروز با افزایش ۱.۵ درصدی به بالاترین سطح تاریخی خود رسید.</p>',
    categories: ['طلا', 'بازار جهانی'],
    daysAgo: 6,
    viewCount: 9400,
    readingTime: 3,
  ...
  },
  {
    ...
    content:
      '<p>بازار سهام آمریکا با شروع فصل گزارش‌های درآمدی، روند صعودی قدرتمندی را تجربه می‌کند.</p>',
  ...
  },
  {
    ...
    content:
      '<p>ETFهای درآمد ثابت با تقسیم سود ماهانه، گزینه‌ای جذاب برای سرمایه‌گذاران ریسک‌گریز هستند.</p>',
  ...
  },
  {
    ...
    content:
      '<p>عرضه‌ی اولیه‌ی سهام «ثالوند» فردا با نماد «ثالوند» در بازار فرابورس انجام می‌شود.</p>',
    categories: ['بورس'],
    daysAgo: 6,
    viewCount: 15400,
    readingTime: 5,
  ...
  },
  {
    ...
    content:
      '<p>در این راهنما با اندیکاتور RSI، نحوه‌ی محاسبه، سیگنال‌ها و محدودیت‌های آن آشنا می‌شوید.</p>',
  ...
  },
  {
    ...
    content:
      '<p>در این مطلب مهم‌ترین الگوهای کندلی شامل دوجی، چکش و ستاره‌ی دنباله‌دار آموزش داده می‌شود.</p>',
    categories: ['تحلیل تکنیکال'],
    daysAgo: 10,
    viewCount: 24300,
    readingTime: 9,
...
async function backfillPostImages(_categoryMap: Map<string, string>) {
