...
func (cc *CategoryCreate) AddParentCategoryIDs(ids ...string) *CategoryCreate {
	cc.mutation.AddParentCategoryIDs(ids...)
	return cc
}

// AddParentCategories adds the "parent_categories" edges to the Category entity.
func (cc *CategoryCreate) AddParentCategories(c ...*Category) *CategoryCreate {
	ids := make([]string, len(c))
	for i := range c {
		ids[i] = c[i].ID
	}
	return cc.AddParentCategoryIDs(ids...)
}

// AddChildCategoryIDs adds the "child_categories" edge to the Category entity by IDs.
func (cc *CategoryCreate) AddChildCategoryIDs(ids ...string) *CategoryCreate {
...
func (cc *CategoryCreate) createSpec() (*Category, *sqlgraph.CreateSpec) {
	...
	if nodes := cc.mutation.ParentCategoriesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
