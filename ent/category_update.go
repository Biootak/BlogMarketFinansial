...
func (cu *CategoryUpdate) AddParentCategoryIDs(ids ...string) *CategoryUpdate {
	cu.mutation.AddParentCategoryIDs(ids...)
	return cu
}

// AddParentCategories adds the "parent_categories" edges to the Category entity.
func (cu *CategoryUpdate) AddParentCategories(c ...*Category) *CategoryUpdate {
	ids := make([]string, len(c))
	for i := range c {
		ids[i] = c[i].ID
	}
	return cu.AddParentCategoryIDs(ids...)
}

// AddChildCategoryIDs adds the "child_categories" edge to the Category entity by IDs.
func (cu *CategoryUpdate) AddChildCategoryIDs(ids ...string) *CategoryUpdate {
...
// ClearParentCategories clears all "parent_categories" edges to the Category entity.
func (cu *CategoryUpdate) ClearParentCategories() *CategoryUpdate {
	cu.mutation.ClearParentCategories()
	return cu
}

// RemoveParentCategoryIDs removes the "parent_categories" edge to Category entities by IDs.
func (cu *CategoryUpdate) RemoveParentCategoryIDs(ids ...string) *CategoryUpdate {
	cu.mutation.RemoveParentCategoryIDs(ids...)
	return cu
}

// RemoveParentCategories removes "parent_categories" edges to Category entities.
func (cu *CategoryUpdate) RemoveParentCategories(c ...*Category) *CategoryUpdate {
	ids := make([]string, len(c))
	for i := range c {
		ids[i] = c[i].ID
	}
	return cu.RemoveParentCategoryIDs(ids...)
}
...
func (cu *CategoryUpdate) RemoveChildCategoryIDs(ids ...string) *CategoryUpdate {
...
func (cu *CategoryUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if cu.mutation.ParentCategoriesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   category.ParentCategoriesTable,
			Columns: category.ParentCategoriesPrimaryKey,
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if nodes := cu.mutation.RemovedParentCategoriesIDs(); len(nodes) > 0 && !cu.mutation.ParentCategoriesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   category.ParentCategoriesTable,
	...
	if nodes := cu.mutation.ParentCategoriesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   category.ParentCategoriesTable,
	...
	if cu.mutation.ChildCategoriesCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: category.ChildCategoriesPrimaryKey,
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(category.FieldID, field.TypeString),
			},
...
// AddParentCategoryIDs adds the "parent_categories" edge to the Category entity by IDs.
func (cuo *CategoryUpdateOne) AddParentCategoryIDs(ids ...string) *CategoryUpdateOne {
	cuo.mutation.AddParentCategoryIDs(ids...)
	return cuo
}

// AddParentCategories adds the "parent_categories" edges to the Category entity.
func (cuo *CategoryUpdateOne) AddParentCategories(c ...*Category) *CategoryUpdateOne {
	ids := make([]string, len(c))
	for i := range c {
		ids[i] = c[i].ID
	}
	return cuo.AddParentCategoryIDs(ids...)
}

// AddChildCategoryIDs adds the "child_categories" edge to the Category entity by IDs.
func (cuo *CategoryUpdateOne) AddChildCategoryIDs(ids ...string) *CategoryUpdateOne {
...
// ClearParentCategories clears all "parent_categories" edges to the Category entity.
func (cuo *CategoryUpdateOne) ClearParentCategories() *CategoryUpdateOne {
	cuo.mutation.ClearParentCategories()
	return cuo
}

// RemoveParentCategoryIDs removes the "parent_categories" edge to Category entities by IDs.
func (cuo *CategoryUpdateOne) RemoveParentCategoryIDs(ids ...string) *CategoryUpdateOne {
	cuo.mutation.RemoveParentCategoryIDs(ids...)
	return cuo
}

// RemoveParentCategories removes "parent_categories" edges to Category entities.
func (cuo *CategoryUpdateOne) RemoveParentCategories(c ...*Category) *CategoryUpdateOne {
	ids := make([]string, len(c))
	for i := range c {
		ids[i] = c[i].ID
	}
	return cuo.RemoveParentCategoryIDs(ids...)
}
...
// RemoveChildCategoryIDs removes the "child_categories" edge to Category entities by IDs.
func (cuo *CategoryUpdateOne) RemoveChildCategoryIDs(ids ...string) *CategoryUpdateOne {
...
func (cuo *CategoryUpdateOne) sqlSave(ctx context.Context) (_node *Category, err error) {
	...
	if cuo.mutation.ParentCategoriesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   category.ParentCategoriesTable,
	...
	if nodes := cuo.mutation.RemovedParentCategoriesIDs(); len(nodes) > 0 && !cuo.mutation.ParentCategoriesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   category.ParentCategoriesTable,
	...
	if nodes := cuo.mutation.ParentCategoriesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   category.ParentCategoriesTable,
