...
func (nq *NewsletterQuery) Order(o ...newsletter.OrderOption) *NewsletterQuery {
	nq.order = append(nq.order, o...)
	return nq
}

// QueryUser chains the current query on the "user" edge.
func (nq *NewsletterQuery) QueryUser() *UserQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(newsletter.Table, newsletter.FieldID, selector),
...
func (nq *NewsletterQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (nq *NewsletterQuery) FirstIDX(ctx context.Context) string {
...
func (nq *NewsletterQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (nq *NewsletterQuery) OnlyIDX(ctx context.Context) string {
...
func (nq *NewsletterQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (nq *NewsletterQuery) IDsX(ctx context.Context) []string {
	ids, err := nq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (nq *NewsletterQuery) Clone() *NewsletterQuery {
	...
	return &NewsletterQuery{
		config:     nq.config,
		ctx:        nq.ctx.Clone(),
		order:      append([]newsletter.OrderOption{}, nq.order...),
...
func (nq *NewsletterQuery) WithUser(opts ...func(*UserQuery)) *NewsletterQuery {
	query := (&UserClient{config: nq.config}).Query()
...
func (nq *NewsletterQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Newsletter, error) {
	...
	if query := nq.withUser; query != nil {
		if err := nq.loadUser(ctx, query, nodes, nil,
			func(n *Newsletter, e *User) { n.Edges.User = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (nq *NewsletterQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Newsletter, init func(*Newsletter), assign func(*Newsletter, *User)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*Newsletter)
	for i := range nodes {
...
func (nq *NewsletterQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(newsletter.Table, newsletter.Columns, sqlgraph.NewFieldSpec(newsletter.FieldID, field.TypeString))
	_spec.From = nq.sql
	...
	if fields := nq.ctx.Fields; len(fields) > 0 {
		...
		if nq.withUser != nil {
			_spec.Node.AddColumnOnce(newsletter.FieldUserID)
		}
	}
