  ...
  return (
    <div className="nova-content-area" dir="rtl" aria-busy="true">
      <div className="nova-page-shell">
        {/* Header skeleton */}
        <div className="nova-section-header" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.5rem' }}>
        ...
        <div className="dash-panel" style={{ overflow: 'hidden' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0' }}>
            ...
            {[0, 1, 2, 3, 4].map((i) => (
              <Skeleton key={i} className="h-14 rounded-none" style={{ opacity: 1 - i * 0.12, borderRadius: 0 }} />
            ))}
          </div>
        </div>
      </div>
