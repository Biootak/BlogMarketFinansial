...
const ToggleSwitch = ({
  ...
  >
    <span
      className={`pointer-events-none relative inline-flex h-6 w-6 transform items-center justify-center rounded-full bg-white shadow-[0_2px_8px_rgba(0,0,0,0.15),0_0_0_1px_rgba(0,0,0,0.05)] ring-0 transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] ${enabled ? '-translate-x-7 rotate-180' : '-translate-x-1'}`}
    >
      <span
        className={`absolute inset-0 rounded-full transition-all duration-300 ${enabled ? 'bg-gradient-to-br from-[rgb(var(--c-primary-100))] to-transparent opacity-50' : 'opacity-0'}`}
      />
    </span>
  </button>
);
...
const InputField = ({
  ...
  <div className="group space-y-2.5">
    <label className="block text-sm font-bold text-gray-800 dark:text-gray-200 transition-colors duration-200 group-focus-within:text-[rgb(var(--c-primary-600))] dark:group-focus-within:text-[rgb(var(--c-primary-400))]">
      {label}
    </label>
    <div className="relative">
      ...
      />
      <div
        className={`absolute inset-0 rounded-2xl bg-gradient-to-r from-[rgb(var(--c-primary-500))]/0 via-[rgb(var(--c-primary-400))]/5 to-[rgb(var(--c-primary-500))]/0 opacity-0 transition-opacity duration-300 pointer-events-none ${!readOnly && !disabled ? 'group-focus-within:opacity-100' : ''}`}
      />
    </div>
  </div>
);
  ...
  <div className="group space-y-2.5">
    ...
    <div className="relative">
      ...
      <div className="pointer-events-none absolute right-4 top-1/2 -translate-y-1/2">
        <svg
          className="h-5 w-5 text-gray-400 transition-transform duration-300 group-focus-within:rotate-180 group-focus-within:text-[rgb(var(--c-primary-500))]"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
        >
  ...
  <div className="group relative overflow-hidden rounded-xl sm:rounded-2xl bg-gradient-to-l from-white via-gray-50/50 to-white p-4 sm:p-5 lg:p-6 border border-gray-100/80 sm:border-2 shadow-[0_2px_8px_rgba(0,0,0,0.04),0_1px_2px_rgba(0,0,0,0.06)] transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] hover:border-[rgb(var(--c-primary-200))]/60 hover:shadow-[0_6px_20px_rgba(0,0,0,0.06),0_3px_8px_rgba(0,0,0,0.04)] sm:hover:shadow-[0_8px_24px_rgba(0,0,0,0.08),0_4px_8px_rgba(0,0,0,0.04)] hover:-translate-y-0.5 dark:from-gray-800/80 dark:via-gray-800/60 dark:to-gray-800/80 dark:border-gray-700/80 dark:hover:border-[rgb(var(--c-primary-400))]/40">
    ...
    <div className="relative flex items-center justify-between gap-4 sm:gap-5 lg:gap-6">
      <div className="flex-1 space-y-1 sm:space-y-1.5">
        <h4 className="text-sm sm:text-base font-bold text-gray-900 dark:text-white transition-colors duration-200 group-hover:text-[rgb(var(--c-primary-700))] dark:group-hover:text-[rgb(var(--c-primary-300))]">
          {title}
        </h4>
      ...
      <div className="mb-6 sm:mb-8 lg:mb-10 pb-5 sm:pb-6 lg:pb-8 border-b border-gray-200/60 sm:border-b-2 dark:border-gray-700/60">
        <div className="flex items-start gap-2.5 sm:gap-3 lg:gap-4 mb-2 sm:mb-3">
          ...
          <div className="flex-1">
            <h3 className="text-lg sm:text-xl lg:text-2xl xl:text-3xl font-black text-transparent bg-clip-text bg-gradient-to-l from-gray-900 via-gray-800 to-gray-900 dark:from-white dark:via-gray-100 dark:to-white mb-1 sm:mb-2">
              {title}
            </h3>
            <p className="text-xs sm:text-sm lg:text-base text-gray-600 dark:text-gray-400 leading-relaxed font-medium">
              {description}
            </p>
          </div>
        </div>
...
const ActionButtons = ({
  ...
  <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-end gap-2.5 sm:gap-3 pt-6 sm:pt-8 lg:pt-10 mt-6 sm:mt-8 lg:mt-10 border-t border-gray-200/60 sm:border-t-2 dark:border-gray-700/60">
    ...
    >
      ...
      <RefreshCw
        className={`relative h-3.5 w-3.5 sm:h-4 sm:w-4 transition-transform duration-300 ${loading ? 'animate-spin' : 'group-hover:-rotate-180'}`}
      />
...
export default function SettingsPage() {
  ...
  return (
    <div
      className="min-h-screen rtl py-4 sm:py-6 lg:py-10 bg-gradient-to-br from-gray-50/50 via-white to-gray-50/50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950"
      style={{ direction: 'rtl' }}
    >
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 sm:gap-6 lg:gap-8">
                ...
                <div className="hidden xs:flex gap-3 sm:gap-4 lg:gap-5">
                  <div className="group/stat relative overflow-hidden flex flex-col items-center justify-center rounded-2xl sm:rounded-3xl bg-white/15 backdrop-blur-xl px-5 py-4 sm:px-7 sm:py-5 lg:px-8 lg:py-6 border border-white/25 sm:border-2 shadow-[0_4px_16px_rgba(0,0,0,0.1)] sm:shadow-[0_8px_24px_rgba(0,0,0,0.15)] transition-all duration-300 hover:bg-white/20 hover:scale-105 hover:-translate-y-1">
                    ...
                    <span className="relative text-3xl sm:text-4xl font-black text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.2)]">
                      ۶
                    </span>
                    <span className="relative text-xs sm:text-sm text-white/80 font-bold mt-0.5 sm:mt-1">
                      بخش تنظیمات
                    </span>
                  </div>
                </div>
                      ...
                      {tabs.map((tab) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            >
                              <IconComponent
                                className={`h-4 w-4 ${isActive ? 'text-white' : 'text-gray-600 dark:text-gray-400'}`}
                              />
                            </div>
                  ...
                  {tabs.map((tab) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div
                          className={`absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent translate-x-[-100%] transition-transform duration-700 ${isActive ? 'group-hover:translate-x-[100%]' : ''}`}
                        />

                        {/* Icon with background */}
                        <div
                          className={`relative flex items-center justify-center h-10 w-10 rounded-xl transition-all duration-300 ${isActive ? 'bg-white/20 shadow-[inset_0_2px_8px_rgba(0,0,0,0.1)]' : 'bg-gray-100/80 group-hover:bg-white dark:bg-gray-800/80 dark:group-hover:bg-gray-700/80'}`}
                        >
                          <IconComponent
                            className={`h-5 w-5 shrink-0 transition-all duration-300 ${isActive ? 'text-white scale-110' : 'text-gray-600 group-hover:text-[rgb(var(--c-primary-600))] group-hover:scale-110 dark:text-gray-400'}`}
                          />
                        </div>
                        ...
                        <div className="relative flex flex-col items-start flex-1">
                          ...
                          <span
                            className={`text-xs mt-0.5 leading-tight transition-colors duration-200 ${isActive ? 'text-white/80' : 'text-gray-500 dark:text-gray-500'}`}
                          >
                            {tab.description}
                          </span>
                        </div>
            ...
            <div className="flex-1 min-w-0">
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-end gap-2.5 sm:gap-3 pt-6 sm:pt-8 lg:pt-10 mt-6 sm:mt-8 lg:mt-10 border-t border-gray-200/60 sm:border-t-2 dark:border-gray-700/60">
                    ...
                    >
                      <div className="absolute inset-0 bg-gradient-to-r from-gray-50 to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
                      {loading ? (
                        <Loader2 className="relative h-3.5 w-3.5 sm:h-4 sm:w-4 animate-spin" />
                      ) : (
                        <Mail className="relative h-3.5 w-3.5 sm:h-4 sm:w-4 transition-transform duration-300 group-hover:scale-110" />
                      )}
                ...
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
                    <SelectField
                      ...
                      disabled={loading}
                      options={[
                        { value: 6, label: '6 کاراکتر' },
                        { value: 8, label: '8 کاراکتر' },
                        { value: 10, label: '10 کاراکتر' },
                        { value: 12, label: '12 کاراکتر' },
                      ]}
                    />
                    <SelectField
                  ...
                  <ActionButtons
                    ...
                    onSubmit={() =>
                      toast({
                        title: 'اطلاع',
                        description: 'تنظیمات امنیتی در نسخه بعدی فعال می‌شود',
                      })
                    }
                  />
                </CardSection>
              ...
              {activeTab === 'social' && (
                <CardSection
                  ...
                  description="مدیریت لینک‌های شبکه‌های اجتماعی سایت"
                >
                  <SocialLinksManager />
                </CardSection>
              )}
                  ...
                  <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-end gap-2.5 sm:gap-3 pt-6 sm:pt-8 lg:pt-10 mt-6 sm:mt-8 lg:mt-10 border-t border-gray-200/60 sm:border-t-2 dark:border-gray-700/60">
                    ...
                    >
                      ...
                      {loading ? (
                        ...
                        <Database className="relative h-3.5 w-3.5 sm:h-4 sm:w-4 transition-transform duration-300 group-hover:scale-110" />
                      )}
                      <span className="relative">تست اتصال</span>
                    </button>
                    <button
                ...
                <CardSection title="تنظیمات پیشرفته" description="تنظیمات حرفه‌ای و پیشرفته سیستم">
                    ...
                    <SettingToggleRow
                      ...
                      onChange={() =>
                        handleInputChange(
                          'advanced',
                          'cacheEnabled',
                          !formData.advanced.cacheEnabled,
                        )
                      }
                      disabled={loading}
                    />
                    <SettingToggleRow
                      ...
                      onChange={() =>
                        handleInputChange(
                          'advanced',
                          'apiRateLimit',
                          !formData.advanced.apiRateLimit,
                        )
                      }
                      disabled={loading}
                    />
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
                    ...
                    <SelectField
                      ...
                      onChange={(v) =>
                        handleInputChange('advanced', 'rateLimit', Number.parseInt(v))
                      }
                      disabled={loading}
                      options={[
                        { value: 100, label: '100 درخواست' },
                        { value: 500, label: '500 درخواست' },
                        { value: 1000, label: '1000 درخواست' },
                      ]}
                    />
                    <InputField
