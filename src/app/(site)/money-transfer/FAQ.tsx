...
const faqs = [
  {
    ...
    answer:
      'برای انجام حواله ارزی، ابتدا در سایت ثبت‌نام کنید. سپس از طریق پنل کاربری، درخواست حواله را ثبت کرده و مبلغ مورد نظر را به حساب اعلام شده واریز نمایید. پس از تأیید واریزی، حواله شما در اسرع وقت انجام خواهد شد.',
  },
  {
    question: 'کدام ارزها برای حواله پشتیبانی می‌شوند؟',
    answer:
      'ما طیف گسترده‌ای از ارزها را پشتیبانی می‌کنیم، از جمله دلار آمریکا، یورو، پوند انگلیس، درهم امارات، لیر ترکیه و ین ژاپن. برای اطلاع از لیست کامل ارزها و نرخ‌های روز، لطفاً به بخش "نرخ‌های لحظه‌ای ارز" مراجعه فرمایید.',
  },
  {
