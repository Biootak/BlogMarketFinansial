...
// 2026-08-12: prerender published AUDIO posts at build (same pattern as
// /single) so audio articles serve static HTML instead of on-demand renders.
// Other slugs stay dynamic (dynamicParams=true) and cache afterwards.
export async function generateStaticParams(): Promise<Array<{ slug: string[] }>> {
  const posts = await getPostsForStaticParams(PostType.AUDIO);
