...
/**
 * error.tsx — online-payment route group
 * #27 fix: Error boundary برای صفحه پرداخت آنلاین اضافه شد
 */
  ...
  return (
    <div style={{ padding: 'var(--ds-space-8)', textAlign: 'center', direction: 'rtl' }}>
      ...
      <p style={{ color: 'var(--ds-text-3)', marginBottom: 'var(--ds-space-4)' }}>
        بارگذاری صفحه پرداخت با مشکل مواجه شد. لطفاً دوباره تلاش کنید.
      </p>
      <button
        type="button"
        onClick={reset}
