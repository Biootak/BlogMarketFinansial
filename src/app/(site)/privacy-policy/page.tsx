    ...
    <div className={s.page}>
      <div className="container">
        ...
        <header className={s.header}>
          ...
          <p className={s.sub}>
            ما شفافانه توضیح می‌دهیم که چه اطلاعاتی جمع‌آوری می‌کنیم، چگونه از آن استفاده می‌کنیم و چه
            حق انتخابی به شما می‌دهیم. امنیت و اعتماد شما اولویت ماست.
          </p>
        </header>
          ...
          <div className={s.content}>
            ...
            <article id="pp-rights" className={s.section}>
              ...
              <p className={s.sectionBody}>
                شما نسبت به اطلاعات شخصی خود حقوق زیر را دارید. برای استفاده از هر یک از این حقوق،
                کافی است از طریق صفحه تماس با ما درخواست خود را ثبت کنید. ما ظرف حداکثر ۳۰ روز کاری
                پاسخ خواهیم داد.
              </p>
              ...
              <div className={s.callout}>
                ...
                <div className={s.calloutBody}>
                  ...
                  <p className={s.calloutText}>
                    تمام درخواست‌های مربوط به حقوق شما رایگان و بدون نیاز به توضیح علت هستند. در صورت
                    نیاز به تأیید هویت، فقط از روش‌های امن استفاده می‌کنیم.
                  </p>
                </div>
              </div>
            </article>
            ...
            <article id="pp-changes" className={s.section}>
              ...
              <p className={s.sectionBody}>
                ما ممکن است این سیاست‌نامه را در آینده به‌روزرسانی کنیم. هر تغییر اساسی از طریق ایمیل
                یا اعلان درون‌برنامه‌ای به شما اطلاع داده خواهد شد. تاریخ آخرین به‌روزرسانی در بالای
                این صفحه نمایش داده می‌شود. ادامه استفاده شما از خدمات پس از تغییرات، به معنای پذیرش
                شرایط جدید است.
              </p>
            </article>
