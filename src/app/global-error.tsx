...
export default function ErrorPage({
  ...
  return (
    <div
      dir="rtl"
      className="flex items-center justify-center min-h-screen bg-gradient-to-bl from-primary-100 via-neutral-100 to-secondary-100 dark:from-neutral-900 dark:via-neutral-800 dark:to-neutral-700 py-10 font-vazirmatn"
    >
      <div className="container">
        <div className="w-full max-w-md mx-auto bg-white dark:bg-neutral-800 p-6 rounded-2xl shadow-lg transition-all duration-500 ease-in-out transform hover:shadow-xl animate-fadeIn">
        <div className="text-center">
          ...
          <div className="mt-6 space-y-2">
            ...
            >
              بازگشت به صفحه اصلی
              <span className="absolute start-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                ←
              </span>
            </Link>
          </div>
