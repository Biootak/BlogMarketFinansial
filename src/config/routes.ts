 ...
 * /forgot-password now redirect there. /verify-request and /verify-email
 * redirect to /auth?step=verify (single-flow unification, 2026-08-14).
 * All these stay public so middleware lets the redirect happen.
 */
...
export const adminRoutes = [
  ...
  // 2026-07-31: صفحات بخش platform/operations که در sidebar ADMIN هم نشان داده می‌شوند
  // اما در adminRoutes نبودند → middleware آن‌ها را برای ADMIN رد می‌کرد.
  '/dashboard/helpdesk',
  '/dashboard/helpdesk/[...slug]',
  '/dashboard/communication',
  '/dashboard/communication/[...slug]',
  '/dashboard/jobs',
  '/dashboard/jobs/[...slug]',
  '/dashboard/approvals',
  '/dashboard/approvals/[...slug]',
  '/dashboard/observability',
  '/dashboard/observability/[...slug]',
  // 2026-07-31: بقیه operations/fintech که ADMIN در sidebar می‌بیند
  '/dashboard/exchanges',
...
export const superAdminRoutes = [
  ...
  '/dashboard/settlements',
  '/dashboard/settlements/[...slug]',
  // 2026-07-31: صفحات بخش platform/operations که در sidebar OWNER/SUPERADMIN/ADMIN
  // نشان داده می‌شوند اما در routes نبودند → middleware آن‌ها را رد می‌کرد (دکمه مرده).
  '/dashboard/helpdesk',
  '/dashboard/helpdesk/[...slug]',
  '/dashboard/communication',
  '/dashboard/communication/[...slug]',
