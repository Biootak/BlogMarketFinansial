 ...
 *
 * پاسخ (هر دو شکل پشتیبانی می‌شه):
 *   {
 *     "usd":    { "value": "127800", "change": "1500", "percent": "1.18", ... },
 *     "sekkeh": { "value": "452000000", "change": "3500000", "percent": "0.78", ... },
 *     ...
 *   }
 * یا wrapper:
 *   { "data": { "latest": { ... same as above ... } } }
 *
 *   مقدار `value` به ریال برگردونده می‌شه؛ فراخواننده به تومان تبدیل می‌کنه.
 * ----------------------------------------------------------------------------
 */

const DEFAULT_BASE = 'https://api.navasan.tech/v1/latest/';
