...
// M10: هشدار Serverless — در هرک dyno (و هر runtime اپمرال) حافظهٔ in-memory
// بین نمونه‌ها مشترک نیست. مهاجم با ارسال درخواست از ۵۰ IP مختلف می‌تواند
// ۵۰×۱۰۰ = ۵۰۰۰ درخواست بزند تا اینکه یک نمونه به حد خود برسد. اینجا فیل
// کلوز (fail closed) برای نوع auth امنیت را بالا می‌برد چون بدون Redis همه
// درخواست‌های auth ریجکت می‌شوند. برای production حتماً UPSTASH_REDIS_REST_URL
// تنظیم شود.
//
