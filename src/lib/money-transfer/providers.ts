...
export const FALLBACK_PROVIDERS: ReadonlyArray<TransferProvider> = [
  {
    ...
    active: true,
    order: 1,
    description: 'مرجع میانگین بازار آزاد (TGJU + USDT/Exir)',
  },
  {
    id: 'nobitex',
    name: 'نوبیتکس',
    kind: 'CRYPTO',
    kindLabel: TRANSFER_KIND_LABELS.CRYPTO,
    spreadPercent: 0.3,
    flatFeeToman: 15_000,
    speedMinutes: 10,
    ...
    active: true,
    order: 2,
    description: 'بزرگ‌ترین صرافی دیجیتال ایران (nobitex.ir)',
  },
  {
    id: 'abantether',
    name: 'ابان تتر',
  ...
  },
  {
    ...
    active: true,
    order: 3,
    description: 'صرافی دیجیتال اکسیر (exir.io)',
  },
] as const;
