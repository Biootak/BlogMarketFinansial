...
export const SYMBOL_REGISTRY: SymbolRegistryEntry[] = [
  ...
  },
  {
    ...
    // tgjuKey با DB هماهنگ شد: DB مقدار 'currency_price_afn' دارد که
    // assembler.fallback (priority 2b) با prefix 'currency_' امتحان می‌کند.
    // هر دو 'price_afn' و 'currency_price_afn' در assembler کار می‌کنند.
    tgjuKey: 'price_afn',
    group: 'afghan',
    unit: 'toman',
    divisor: 10,
  ...
  // ── Iran Forex — کریدور خاورمیانه و آسیای مرکزی (اضافه ۲۰۲۶-۰۷) ─────────
  // این ارزها در tgjuKeys.ts/CURRENCY_SYMBOLS وجود دارند ولی در registry نبودند.
  // برای کاربران افغانستانی (حج/عمره/خلیج/پاکستان) ضروری‌اند.
  {
    symbol: 'IRAN_PKR',
  ...
  // ── ارزهای اروپا/اوقیانوسیه/آسیای جنوب‌شرقی (مهاجران افغان) ───────────
  {
    symbol: 'IRAN_SEK',
