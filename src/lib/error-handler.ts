...
export const Errors = {
  ...
  INVALID_CREDENTIALS: new AppError('نام کاربری یا رمز عبور اشتباه است', 401, 'INVALID_CREDENTIALS'),
  ...
  ALREADY_EXISTS: (resource: string) => new AppError(`${resource} قبلاً وجود دارد`, 409, 'ALREADY_EXISTS'),
...
export function logError(error: unknown, context?: Record<string, unknown>): void {
  ...
  // TODO: در production به Sentry یا سرویس مشابه بفرست
