      ...
      <div className="relative rounded-xl sm:rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300">
        ...
        <div className="sm:hidden relative aspect-[16/10] w-full">
          ...
          <div className="absolute inset-0 flex flex-col justify-between p-3">
            ...
            <div className="space-y-2.5">
              <h3 className="font-bold text-[14.5px] sm:text-[15px] leading-[1.4] text-white drop-shadow-lg">
                <Link
                  href={postLink}
        ...
        <div className="hidden sm:flex flex-row items-stretch p-3 md:p-3.5 lg:p-3.5 bg-white/90 dark:bg-neutral-900/90 backdrop-blur-sm border border-neutral-100 dark:border-neutral-800 gap-3 md:gap-3.5 lg:gap-4 relative min-h-[7.5rem] md:min-h-[8rem] lg:min-h-[8.5rem]">
          ...
          <div className="relative flex flex-col flex-grow justify-between min-w-0 py-0.5">
            ...
            {/* Title */}
            <h3 className="font-bold text-[12.5px] md:text-[13px] lg:text-[14px] xl:text-[15px] text-neutral-900 dark:text-neutral-100 leading-snug mb-auto line-clamp-2 break-words text-balance">
              <Link
                href={postLink}
