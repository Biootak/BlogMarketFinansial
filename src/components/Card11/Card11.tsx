...
const Card11: React.FC<Card11Props> = ({
  ...
  return (
    <div
      className={[
        'nc-Card11 relative flex flex-col group overflow-hidden',
        'bg-white/95 dark:bg-neutral-900/95 backdrop-blur-sm',
        'transition-all duration-500',
        'shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_60px_rgba(0,0,0,0.12)]',
        'dark:shadow-[0_4px_20px_rgba(0,0,0,0.2)] dark:hover:shadow-[0_20px_60px_rgba(0,0,0,0.4)]',
    ...
    >
      ...
      <div className="relative p-5 lg:p-6 flex flex-col gap-3 flex-1 z-10">
        {!hiddenAuthor ? (
          ...
          <span className={text.meta}>{createdAt.toString()}</span>
        )}
