...
export const ColorPicker = memo(
  ({ color, onChange, onClear, showOpacity = true }: ColorPickerProps) => {
    ...
    const updateFinalColor = useCallback(
      ...
      <div className="flex flex-col gap-3 p-1 min-w-[280px]">
        ...
        {activeTab === 'palette' ? (
          ...
          <div className="space-y-3">
            <HexColorPicker className="!w-full !h-40" color={hexColor} onChange={handleHexChange} />
