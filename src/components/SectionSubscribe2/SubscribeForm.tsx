    ...
    >
      <div className="relative flex items-center">
        ...
        <Button
          ...
          className="absolute end-1.5 sm:end-2 top-1/2 -translate-y-1/2 h-8 sm:h-10 px-3 sm:px-5 bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-500 hover:to-amber-600 text-white text-xs sm:text-sm font-bold rounded-lg sm:rounded-xl shadow-lg shadow-amber-500/30 transition-all duration-300 hover:shadow-amber-500/50 hover:scale-105 disabled:opacity-70 disabled:hover:scale-100"
        >
          {isLoading ? (
