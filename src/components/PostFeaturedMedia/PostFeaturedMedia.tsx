    ...
    >
      {postType !== 'GALLERY' && featuredImage && (
        <Image
          ...
          loading="lazy"
          placeholder="blur"
          blurDataURL="data:image/jpeg;base64,"
        />
      )}
