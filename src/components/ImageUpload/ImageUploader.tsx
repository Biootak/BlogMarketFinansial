...
export const ImageUploader = forwardRef<ImageUploaderRef, ImageUploaderProps>(
  ({ onImageUpload, onImageRemove, maxFiles = 1, multiple = false, initialPreviews = [] }, ref) => {
...
export const withImageUploaderRef = (WrappedComponent: React.ComponentType<any>) => {
  return React.forwardRef<ImageUploaderRef, ImageUploaderProps>((props, ref) => {
    return <WrappedComponent {...props} imageUploaderRef={ref} />;
  });
};

export const ImageUploaderWithRef = withImageUploaderRef(ImageUploader);
