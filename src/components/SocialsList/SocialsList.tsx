      ...
      {socials.map((item, index) => {
        ...
        return (
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className={`${itemClass} rounded-full p-2 transition-all duration-300 ease-in-out bg-white dark:bg-neutral-800 shadow-lg hover:shadow-xl hover:bg-neutral-100 dark:hover:bg-neutral-700 font-sans`}
            href={item.href}
            target="_blank"
