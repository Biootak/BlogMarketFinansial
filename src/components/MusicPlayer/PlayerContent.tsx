...
//   const [isShowContentOnMobile, setIsShowContentOnMobile] = React.useState(false);
...
//   const renderLeft = () => {
//     const { href = '/', featuredImage = '', categories = [], title = '' } = post || {};
//     return (
...
//         {/* PLAYING */}
//         {playing ? (
//           <HiPause className="w-10 h-10" />
//         ) : (
//           <HiPlay className="ms-0.5 w-10 h-10 rtl:rotate-180" />
//         )}
//       </div>
//     );
//   };
...
//         <svg className="w-6 h-6 block rtl:hidden" viewBox="0 0 24 24" fill="none">
//           <path
