...
export function LazySidebar({ children }: { children: ReactNode }) {
  return (
    <LazyLoad rootMargin="200px" threshold={0}>
      {children}
    </LazyLoad>
  );
}
...
export function LazyFooter({ children }: { children: ReactNode }) {
  return (
    <LazyLoad rootMargin="300px" threshold={0} triggerOnce>
      {children}
    </LazyLoad>
  );
}
...
export function LazyComments({ children }: { children: ReactNode }) {
  return (
    <LazySection minHeight="400px" className="mt-8">
      {children}
    </LazySection>
  );
}
...
export function LazyRelatedPosts({ children }: { children: ReactNode }) {
  return (
    <LazySection minHeight="300px" className="mt-12">
      {children}
    </LazySection>
  );
}
...
export function PrefetchLink({ href, children, className = '' }: PrefetchLinkProps) {
  ...
  return (
    <a href={href} className={className} {...preloadProps}>
      {children}
    </a>
  );
}
