...
const AuthorCard = React.forwardRef<HTMLAnchorElement, AuthorCardProps>(function AuthorCard(
  ...
  if (variant === 'compact') {
    return (
      ...
      >
        <AuthorAvatar size={avatarSizeFinal} imgUrl={avatar} userName={displayName} />
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className={cn('mt-3 w-full min-w-0', variant === 'feature' && 'sm:mt-0 sm:flex-1')}>
          <h3
            className={cn(
              ...
              variant === 'feature' ? 'text-lg sm:text-xl' : 'text-sm sm:text-[15px]',
            )}
          >
            {displayName}
          </h3>
