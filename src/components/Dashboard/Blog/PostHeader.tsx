        ...
        <div className="flex items-center justify-between gap-4 sm:gap-6">
          ...
          <Link href="/dashboard/posts/create" className="w-auto">
            <ButtonPrimary
              ...
              className="bg-transparent border border-primary-500 text-primary-500 hover:bg-primary-200 dark:hover:bg-primary-900 sm:bg-gradient-to-l sm:from-primary-500 sm:to-secondary-500 sm:hover:from-primary-600 sm:hover:to-secondary-600 sm:text-white font-medium py-2 px-3 sm:px-6 rounded-md sm:rounded-full shadow-lg hover:shadow-xl transition-all duration-300 group"
            >
              <HiOutlinePlus
